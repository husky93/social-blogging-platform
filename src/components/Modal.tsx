...
interface ModalProps {
  ...
  handleModalClose: React.MouseEventHandler<HTMLDivElement | HTMLButtonElement>;
}
...
const Modal: React.FC<ModalProps> = ({ children, handleModalClose }) => {
  return (
    <div
      id="popup-modal"
      className="overlay overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-screen md:h-full justify-center items-center flex bg-slate-900 bg-opacity-50"
